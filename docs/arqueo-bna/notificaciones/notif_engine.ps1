param($MasterCsv,$CorreoPrueba,$Rutaa030,$LinkMaster,$FechaHoy,$FechaEnvio)
$ErrorActionPreference='Stop'
$ci=[Globalization.CultureInfo]::InvariantCulture

$cat=@{}
$cat['4004']=@{codEnt='4';ent='CAJA DE CREDITO DE BERLIN';nombre='C.C. BERLIN - DEPOSITARIO CENTRAL';interno='DEP04004'}
$cat['1505']=@{codEnt='15';ent='CAJA DE CREDITO DE CHALCHUAPA';nombre='CC CHALCHUAPA - AGENCIA SANTA ANA DE POSITARIO';interno='DEP15005'}
$cat['1607']=@{codEnt='16';ent='CAJA DE CREDITO DE ZACATECOLUCA';nombre='C.C.ZACATECOLUCA - AG. CENTRAL DEPOSITARIO';interno='DEP16007'}
$cat['1609']=@{codEnt='16';ent='CAJA DE CREDITO DE ZACATECOLUCA';nombre='CC ZACATECOLUCA DEPOSITARIO AG SAN RAFAEL OBRAJUELO';interno='DEP16009'}
$cat['2210']=@{codEnt='22';ent='CAJA DE CREDITO DE SONSONATE';nombre='CC SONSONATE DEPOSITARIO AG CENTRAL';interno='DEP22010'}
$cat['2211']=@{codEnt='22';ent='CAJA DE CREDITO DE SONSONATE';nombre='CCSONSONATE-AGENCIA SAN MIGUEL DEPPSOITARIO';interno='DEP22011'}
$cat['2212']=@{codEnt='22';ent='CAJA DE CREDITO DE SONSONATE';nombre='CCSONSONATE-AGENCIA METALIO SONSONATE DEPOSITARIO';interno='DEP22012'}
$cat['2804']=@{codEnt='28';ent='CAJA DE CREDITO DE SANTA ANA';nombre='CC SANTA ANA AGENCIA PLAZA MERLIOT';interno='DEP28004'}
$cat['3005']=@{codEnt='30';ent='CAJA DE CREDITO DE SAN MARTIN';nombre='CC SAN MARTIN - AGENCIA METROCENTRO';interno='DEP30005'}
$cat['3006']=@{codEnt='30';ent='CAJA DE CREDITO DE SAN MARTIN';nombre='CC SAN MARTIN DEPOSITARIO AG CENTRAL';interno='DEP30006'}
$cat['3205']=@{codEnt='32';ent='CAJA DE CREDITO DE SAN VICENTE';nombre='CC SAN VICENTE DEPOSITARIO AGENCIA LAS CASCADAS';interno='DEP32005'}
$cat['3604']=@{codEnt='36';ent='CAJA DE CREDITO DE CIUDAD BARRIOS';nombre='CC CIUDAD BARRIOS AGENCIA EX TERMINAL DEPO.';interno='DEP36004'}
$cat['3703']=@{codEnt='37';ent='CAJA DE CREDITO DE ATIQUIZAYA';nombre='AGENCIA ATIQUIZAYA CENTRAL BNA';interno='DEP37003'}
$cat['4207']=@{codEnt='42';ent='CAJA DE CREDITO DE SOYAPANGO';nombre='CC SOYAPANGO -DEPOSITARIO UNICENTRO SOYAPANGO';interno='DEP42007'}
$cat['4605']=@{codEnt='46';ent='CAJA DE CREDITO DE NUEVA CONCEPCIÓN';nombre='CC NUEVA CONCEPCION - CENTRAL Depositario 1';interno='DEP46005'}
$cat['4607']=@{codEnt='46';ent='CAJA DE CREDITO DE NUEVA CONCEPCIÓN';nombre='CC NUEVA CONCEPCION -CENTRAL DESPOSITARIO 2';interno='DEP46007'}
$cat['5306']=@{codEnt='53';ent='CAJA DE CREDITO DE CANDELARIA LA FRONTERA';nombre='CC CANDELARIA DE LA FRONTERA DEPOSITARIO CENTRAL';interno='DEP53006'}
$cat['5307']=@{codEnt='53';ent='CAJA DE CREDITO DE CANDELARIA LA FRONTERA';nombre='CC CANDELARIA DE LA FRONTERA DEPOSITARIO STA ANA';interno='DEP53007'}
$cat['7205']=@{codEnt='72';ent='BANCOMI';nombre='BANCOMI- AGENCIA CENTRAL DEPO.';interno='DEP72005'}
$cat['9949']=@{codEnt='99';ent='FEDECRÉDITO';nombre='LOBY-FEDECREDITO DEPOSITARIO';interno='DEP99049'}
$cat['9988']=@{codEnt='99';ent='FEDECRÉDITO';nombre='FEDECREDITO AG WORLD TRADE CENTER DEPOSITARIO';interno='DEP99088'}
$cat['9990']=@{codEnt='99';ent='FEDECRÉDITO';nombre='FEDECREDITO DEPOSITARIO AG MULTIPLAZA';interno='DEP99090'}
...
$SHELL_EJEC=@'
<table role="presentation" cellpadding="0" cellspacing="0" width="1000" style="border-collapse:collapse;background:#ffffff;font-family:Arial,Helvetica,sans-serif;">
...
'@
$SHELL_FIN=@'
<table role="presentation" cellpadding="0" cellspacing="0" width="920" style="border-collapse:collapse;background:#fff;font-family:Arial,Helvetica,sans-serif;">
<tr><td style="background:#1e8a4c;height:60px;text-align:center;color:#fff;font-size:18px;font-weight:bold;">Sistema FEDECREDITO &nbsp;&middot;&nbsp; RPA</td></tr>
<tr><td style="background:#efefef;border:1px solid #d8d8d8;padding:6px 12px;font-size:13px;font-weight:bold;color:#333;">Notificacion del Robot</td></tr>
